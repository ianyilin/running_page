...
const runRed = '#e64755';
const deepTeal = '#287f89';

// If your map has an offset please change this line
// issues #92 and #198
export const NEED_FIX_MAP = false;
export const MAIN_COLOR = runRed;
export const PROVINCE_FILL_COLOR = '#287f89';
export const COUNTRY_FILL_COLOR = '#f0b74a';

// Static color constants
export const RUN_COLOR_LIGHT = deepTeal;
